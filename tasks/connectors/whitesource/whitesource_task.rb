...
module Kenna
  module Toolkit
    class WhitesourceTask < Kenna::Toolkit::BaseTask
      ...
      def self.metadata
        {
          ...
          options: [
            ...
            { name: "kenna_batch_size",
              ...
              required: false,
              default: 100,
              description: "Maximum number of issues to send to kenna in each batch. Default is 100" },
            { name: "kenna_api_key",
              type: "api_key",
              required: false,
              default: nil,
