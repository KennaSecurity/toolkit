  ...
  module Toolkit
    class ArmisTask < Kenna::Toolkit::BaseTask
      ...
      def self.metadata
        {
          ...
          options: [
            ...
            { name: "kenna_api_host",
              type: "hostname",
              required: false,
              default: "api.sandbox.us.kennasecurity.com",
            ...
            { name: "enable_checkpoint",
              ...
              required: false,
              default: false,
              description: "Enable Checkpoint Feature for Scheduling" },
      ...
      def run(opts)
        ...
        initialize_options
        client = Kenna::Toolkit::Armis::Client.new(@armis_api_host, @armis_api_secret_token)
