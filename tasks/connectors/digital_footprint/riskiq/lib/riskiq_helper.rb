  ...
  module Toolkit
    module RiskIQHelper
      ...
      def convert_riq_output_to_kdi(data_items)
        ...
        # kdi_initialize
        @fm = Kenna::Toolkit::Data::Mapping::DigiFootprintFindingMapper.new(@output_directory, @options[:input_directory], @options[:df_mapping_filename]) if @options[:input_directory] && @options[:df_mapping_filename]
