...
module Kenna
  module Toolkit
    class HackeroneTask < Kenna::Toolkit::BaseTask
      ...
      def self.metadata
        {
          ...
          options: [
            ...
            # { name: "hackerone_schedule_id",
            #   type: "string",
            #   required: true,
            #   default: nil,
            #   description: "A list of HackerOne Schedule ID (comma separated)" },
      ...
      rescue Kenna::Toolkit::Hackerone::HackeroneClient::ApiError => e
        fail_task e.message
      end
      ...
      def initialize_client
        @client = Kenna::Toolkit::Hackerone::HackeroneClient.new(@api_user, @api_password, @api_program)
      end
