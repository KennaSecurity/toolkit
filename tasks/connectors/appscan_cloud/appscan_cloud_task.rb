...
module Kenna
  module Toolkit
    class AppScanCloudTask < Kenna::Toolkit::BaseTask
      def self.metadata
        {
          id: "appscan_cloud",
      ...
      rescue Kenna::Toolkit::AppScanCloud::Client::ApiError => e
        fail_task e.message
      end
      ...
      def initialize_client
        @client = Kenna::Toolkit::AppScanCloud::Client.new(@api_id, @api_secret)
      end
